/**
 * This Old Man - partitura do repertório do Treino.
 *
 * GERADO por `tools/partituras-import/import_scores.py` a partir de
 * `this-old-man.json` - não editar à mão.
 */
import type { ScoreJSON } from '../score';

export const THIS_OLD_MAN: ScoreJSON = {
  id: 'this-old-man',
  title: 'This Old Man',
  collection: 'ballads',
  ...
  toleranceCents: 30,
  source: {
    pitches: 'Tablatura de 6 furos "This Old Man.pdf" (whistle em Ré), decodificada por imagem',
